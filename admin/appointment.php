            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <!-- <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <center>
                            <a href="issue-ticket.php" class="non-style-link">
                                <button class="login-btn btn-primary btn" style="padding: 15px; margin: 0 10px;">
                                    Issue Manual Ticket
                                </button>
                            </a>
                        </center>
                ...
                <tr>
                    <td colspan="4">
                        <center>
                            <!-- Generate Appointment Report button removed -->
                        </center>
                    </td>
                </tr>
