...
<body>
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="fee" class="form-label">Session Fee (LKR): </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="fee" class="input-text" placeholder="Leave blank to use doctor\'s default fee" step="0.01">
                                </td>
                            </tr>
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop,schedule.session_fee,schedule.docid from schedule inner join doctor on schedule.docid=doctor.docid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["docname"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <tr>
                            <td>
                                <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Session.</p>
                                <br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="text" name="title" class="input-text" placeholder="Name of this Session" value="'.$title.'" required><br>
                            </td>
                            
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="docid" class="form-label">Doctor of this session: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="number" name="nop" class="input-text" min="0"  placeholder="The final appointment number for this session depends on this number" value="'.$nop.'" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="number" name="fee" class="input-text" placeholder="Leave blank to use doctor\'s default fee" step="0.01" '.($session_fee !== null ? "value=\"$session_fee\"" : "").'>
                            </td>
                        </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                        '.substr($titleget,0,40).' was updated.<br><br>
            ...
            if($error=='duplicate_session'){
                ...
                <div id="popup1" class="overlay">
                        ...
                        <br><br>
                            ...
                            <a class="close" href="schedule.php">&times;</a>
                            <div class="content">
                            A session is already scheduled for the same doctor at the same time on the same date.<br><br>
                ...
                <div id="popup1" class="overlay">
                        ...
                        <br><br>
                            ...
                            <a class="close" href="schedule.php">&times;</a>
                            <div class="content">
                            Required fields are missing. Please fill in all required fields.<br><br>
                ...
                <div id="popup1" class="overlay">
                        ...
                        <br><br>
                            ...
                            <a class="close" href="schedule.php">&times;</a>
                            <div class="content">
                            Failed to update session. Please try again.<br><br>
