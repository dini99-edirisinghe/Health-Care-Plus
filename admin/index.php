...
<body>
    ...
    $unreadNotificationsQuery = $database->query("
        SELECT COUNT(*) AS unread_count 
        FROM session_notifications 
        WHERE (docid IS NOT NULL OR patid IS NOT NULL) 
        AND status = 'pending'
    ");
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-notification">
                        <a href="notifications.php" class="non-style-link-menu notification-link"><div><p class="menu-text">System Notifications</p><?php if($unreadNotificationsCount > 0): ?><span class="notification-dot"></span><?php endif; ?></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-notification">
                        <a href="patient-notifications.php" class="non-style-link-menu"><div><p class="menu-text">Patient Notifications</p></a></div>
                    </td>
                </tr>
            </table>
        </div>
