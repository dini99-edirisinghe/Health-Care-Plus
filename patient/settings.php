...
<body>
    ...
    if(isset($_GET)){
        ...
        if($action=='drop'){
            ...
            $name= isset($row["pname"]) ? $row["pname"] : '';
            $email= isset($row["pemail"]) ? $row["pemail"] : '';
            $address= isset($row["paddress"]) ? $row["paddress"] : '';
            $nic= isset($row["pnic"]) ? $row["pnic"] : '';
            $dob= isset($row["pdob"]) ? $row["pdob"] : '';
            $tele= isset($row["ptel"]) ? $row["ptel"] : '';
