...
<body>
    ...
    if ($_POST) {
        if (isset($_POST['submit_feedback'])) {
            ...
            $sql = "INSERT INTO feedback (user_id, user_type, subject, message) VALUES (?, 'patient', ?, ?)";
            $stmt = $database->prepare($sql);
            $stmt->bind_param("iss", $pid, $subject, $message);
            if ($stmt->execute()) {
                setMessage("Feedback submitted successfully! We'll review your message and respond soon.", "success");
            } else {
                setMessage("There was an error submitting your feedback. Please try again.", "error");
            }
            $stmt->close();
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-feedback active">
                        <a href="feedback.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Feedback</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Submit Feedback</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Submit New Feedback</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-top:0px;">
                        ...
                        <form method="post" action="">
                            <table width="90%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="text" name="subject" class="input-text" placeholder="Enter feedback subject..." required><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <textarea name="message" class="input-text" placeholder="Enter your feedback message..." rows="5" required></textarea><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="submit" name="submit_feedback" value="Submit Feedback" class="login-btn btn-primary btn">
                                    </td>
                                </tr>
                            </table>
                        </form>
                ...
                <tr>
                    <td colspan="4" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Your Feedback History</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        ...
                        <tbody>
                            ...
                            $sqlmain = "SELECT * FROM feedback WHERE user_id=? AND user_type='patient' ORDER BY created_date DESC";
                            $stmt = $database->prepare($sqlmain);
                            ...
                            if($result->num_rows==0){
                                echo '<tr>
                                <td colspan="4">
                                <br><br><br><p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49);text-align:center;">You have no feedback messages yet.</p><br><br><br>
                                </td>
                                </tr>';
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'view' && isset($_GET['id'])) {
        ...
        if ($feedback['response']) {
            ...
            echo '
                            <tr>
                                <td class="label-td" colspan="2">
                                    <p style="color: orange;">Waiting for admin response...</p><br><br>
                                </td>
                            </tr>';
        }
