                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $consultation_fee = $row["session_fee"] ?? $row["consultation_fee"];
                                    
                                    $fee = $consultation_fee + HOSPITAL_SERVICE_FEE;
                                    $stmt->close(); 
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Consultation fee : <b>LKR.'.$consultation_fee.'</b><br>
                                                            Hospital service fee : <b>LKR.'.HOSPITAL_SERVICE_FEE.'</b><br>
                                                            <hr>
                                                            <strong>Total amount : <b>LKR.'.$fee.'</b></strong>
