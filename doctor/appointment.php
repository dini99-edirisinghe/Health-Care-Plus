                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <form action="" method="post">
                            ...
                            <input type="date" name="sheduledate" id="date" class="input-text filter-container-items" style="margin: 0;width: 95%;" value="<?php echo isset($_POST['sheduledate']) ? htmlspecialchars($_POST['sheduledate']) : ''; ?>">
                        ...
                        <td width="20%">
                            <input type="text" name="patientname" class="input-text filter-container-items" placeholder="Patient Name" style="margin: 0;width: 95%;" value="<?php echo isset($_POST['patientname']) ? htmlspecialchars($_POST['patientname']) : ''; ?>">
                        </td>
                ...
                <?php
                    ...
                    if($_POST){
                        ...
                        if(!empty($_POST["patientname"])){
                            $patientname=$database->real_escape_string($_POST["patientname"]);
                            $sqlmain.=" and patient.pname LIKE '%$patientname%' ";
                        };
