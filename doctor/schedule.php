...
// Handle notify admin submission
if(isset($_POST['notify_admin'])){
    $schedule_id = intval($_POST['schedule_id']);
    $message = $database->real_escape_string($_POST['message']);
    
    $database->query("INSERT INTO session_notifications (scheduleid, docid, message, notify_date) 
                      VALUES ($schedule_id, $userid, '$message', NOW())");
...
if($_GET){
    ...
    if($action=='drop'){
        ...
        <div id="popup1" class="overlay">
            ...
            <center>
                ...
                <div style="display: flex;justify-content: center;">
                    <a href="delete-session.php?id='.$id.'" class="non-style-link"><button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">&nbsp;Yes&nbsp;</button></a>&nbsp;&nbsp;&nbsp;
    ...
    elseif($action=='view'){
        ...
        $sqlmain12= "SELECT * FROM appointment INNER JOIN patient ON patient.pid=appointment.pid 
            ...
            <center>
                ...
                <div class="abc scroll" style="display: flex;justify-content: center;">
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label class="form-label">Doctor of this session: </label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label class="form-label"><b>Patients Already Registered:</b> ('.$result12->num_rows."/".$nop.')</label><br><br>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                ...
                                <div class="abc scroll">
                                    <table width="100%" class="sub-table scrolldown" border="0">
                                        ...
                                        if($result12->num_rows==0){
                                            echo '<tr><td colspan="4"><center>No patients registered yet</center></td></tr>';
                                        } else {
                        ...
                        <tr>
                            <td colspan="2">
                                <form method="post">
                                    ...
                                    <label class="form-label"><b>Notify Admin:</b></label><br>
                                    <textarea name="message" class="input-text" placeholder="I will not be able to conduct this session today" required style="width:100%;height:80px;margin-bottom:10px;"></textarea><br>
                                    <input type="submit" name="notify_admin" class="btn-primary btn" value="Notify Admin">
                                </form>';
                                if(isset($notification_sent) && $notification_sent){
                                    echo '<p style="color:green;margin-top:10px;">Notification sent to admin successfully!</p>';
                                }
                                echo '
                            </td>
                        </tr>
