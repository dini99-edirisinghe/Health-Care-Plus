...
<body>
                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <a href="upload-profile-picture.php" class="non-style-link">
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $spcil_name= isset($spcil_array["sname"]) ? $spcil_array["sname"] : "Not Specified";
            $nic= isset($row['docnic']) ? $row['docnic'] : '';
            $tele= isset($row['doctel']) ? $row['doctel'] : '';
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <div style="text-align: center; margin-bottom: 20px;">
                                        ';
                                        if($profile_picture) {
                                            echo '<img src="../uploads/profile_pictures/' . htmlspecialchars($profile_picture) . '" alt="Profile Picture" style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 3px solid #3b82f6;">';
                                        } else {
                                            echo '<img src="../img/user.png" alt="Profile Picture" style="width: 150px; height: 150px; border-radius: 50%; border: 3px solid #ccc;">';
                                        }
                                        echo '
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <div style="text-align: center; margin-bottom: 20px;">
                                            ';
                                            if(isset($userfetch["profile_picture"]) && $userfetch["profile_picture"]) {
                                                echo '<img src="../uploads/profile_pictures/' . htmlspecialchars($userfetch["profile_picture"]) . '" alt="Profile Picture" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 2px solid #3b82f6;">';
                                            } else {
                                                echo '<img src="../img/user.png" alt="Profile Picture" style="width: 100px; height: 100px; border-radius: 50%; border: 2px solid #ccc;">';
                                            }
                                            echo '
                                            <br><small>Current Profile Picture</small>
                                        </div>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <select name="spec" id="" class="box">';
                                                ...
                                                $current_specialty_id = $row["specialties"];  // Get the current specialty ID of the doctor
                                                for ($y=0;$y<$list11->num_rows;$y++){
                                                    $row00=$list11->fetch_assoc();
                                                    $sn=$row00["sname"];
                                                    $id00=$row00["id"];
                                                    if($id00==$current_specialty_id){
