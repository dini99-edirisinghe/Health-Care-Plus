...
<body>
    ...
    include("../includes/health-tips-utility.php");
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="10%" style="text-align:right;padding-right:20px;">
                                <a href="notifications.php" class="notification-link" style="display:inline-block; text-decoration:none; margin-right:12px;">
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <a href="generate_report.php" class="non-style-link"><button class="btn-primary btn" style="width:30%; margin-left: 10px;">Patient Documents</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
