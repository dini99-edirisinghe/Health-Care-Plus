...
?>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       <a href="?action=view_docs&id='.$pid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;margin-left: 10px;"><font class="tn-in-text">View Docs</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        if($action=='view_docs'){
            // Get patient documents created by this doctor
            $sql_docs = "SELECT md.*, p.pname FROM medical_documents md JOIN patient p ON md.patient_id = p.pid WHERE md.patient_id = ? AND md.doctor_id = ? ORDER BY md.created_date DESC";
            $stmt_docs = $database->prepare($sql_docs);
            $stmt_docs->bind_param("ii", $id, $userid);
            $stmt_docs->execute();
            ...
            <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <div class="content">
                        <h2>Patient Documents for Patient</h2>
                    </div>
                    <div style="display: flex;justify-content: center;">
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Patient Documents</p><br><br>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                ...
                if($result_docs->num_rows==0){
                    ...
                    <br><br><br><br>
                    <center>
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No patient documents found for this patient!</p>
                    </center>
                    <br><br><br><br>
                    </td>
                    </tr>';
                    ...
                    while($doc = $result_docs->fetch_assoc()) {
                        echo '<tr>
                            ...
                            <td>
                            <div style="display:flex;justify-content: center;">
                                <a href="?action=view_single_doc&id='.$doc["document_id"].'" class="non-style-link"><button class="btn-primary-soft btn button-icon btn-view">View</button></a>
                            </div>
                            </td>
                        </tr>';
                    }
                ...
                <tr>
                    <td colspan="2">
                        <a href="patient.php"><input type="button" value="Close" class="login-btn btn-primary-soft btn" ></a>
                    </td>
                </tr>
        ...
        elseif($action=='view_single_doc'){
            $doc_id = $_GET["id"];
            
            // Verify that the document belongs to this patient and was created by this doctor
            $sql = "SELECT md.*, p.pname FROM medical_documents md JOIN patient p ON md.patient_id = p.pid WHERE md.document_id = ? AND md.patient_id = ? AND md.doctor_id = ?";
            $stmt = $database->prepare($sql);
            $stmt->bind_param("iii", $doc_id, $id, $userid);
            $stmt->execute();
            ...
            if ($result->num_rows > 0) {
                ...
                <div id="popup1" class="overlay">
                    <div class="popup">
                        <center>
                            ...
                            <a class="close" href="patient.php?action=view_docs&id='.$id.'">&times;</a>
                            <div class="content">
                                <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 20px;font-weight: 500;">'.ucfirst(str_replace('_', ' ', $document['document_type'])).'</p><br>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 16px;color: #666;">Generated on '.date('F j, Y', strtotime($document['created_date'])).'</p><br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <div style="text-align: left; white-space: pre-wrap;">'.nl2br(htmlspecialchars($document['document_content'])).'</div><br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <a href="patient.php?action=view_docs&id='.$id.'"><input type="button" value="Back" class="login-btn btn-primary-soft btn" ></a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                // Document not found or doesn't belong to this patient/docto
