...
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    $database->query("DELETE FROM session_notifications WHERE id=$id AND docid=$userid");
...
if (isset($_GET['view'])) {
    $id = (int)$_GET['view'];
    $database->query("UPDATE session_notifications SET status='seen' WHERE id=$id AND docid=$userid");
    $notif_query = $database->query("SELECT * FROM session_notifications WHERE id=$id AND docid=$userid");
...
$notifications = $database->query("SELECT id, message, notify_date, status FROM session_notifications WHERE docid=$userid ORDER BY notify_date DESC");
